                ...
                <div class="p-6 lg:p-8 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center pb-6 border-b border-gray-200 dark:border-gray-700">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Criado em {{ \Carbon\Carbon::parse($atendimento->created_at)->format('d/m/Y H:i') }}</p>
                        </div>
                    ...
                    <div class="mt-8 mb-4">
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach([
                                ['label' => 'Projeto', 'value' => $atendimento->projeto->name, 'icon' => 'fa-project-diagram'], // Ícone para projeto
                                ['label' => 'Status', 'value' => $atendimento->status, 'icon' => 'fa-tasks'], // Ícone para status
                                ['label' => 'Descrição', 'value' => $atendimento->descricao, 'icon' => 'fa-file-alt'], // Ícone para descrição
                            ] as $item)
                                <div class="space-y-2">
