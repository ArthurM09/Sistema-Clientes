...
<body class="font-sans antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            <h1 class="text-2xl font-bold text-center mb-4 text-gray-400">Editar Atendimento</h1>
            ...
            <form method="POST" action="{{ route('atendimentos.update', $atendimento) }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="assunto" class="block mt-1 w-full" type="text" name="assunto" :value="old('assunto', $atendimento->assunto)" required autofocus />
                    <x-input-error :messages="$errors->get('assunto')" class="mt-2" />
                </div>

                <div class="mt-4">
                    <x-input-label for="descricao" :value="__('Descrição')" />
                    <textarea id="descricao" name="descricao" class="block mt-1 w-full">{{ old('descricao', $atendimento->descricao) }}</textarea>
